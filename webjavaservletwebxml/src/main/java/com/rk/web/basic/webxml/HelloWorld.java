package com.rk.web.basic.webxml;
...
*  curl "http://localhost:8080/webjavaservletwebxml/hello?a=Str1&b=Str2"
*  curl --request POST --data "This is body" "http://localhost:8080/webjavaservletwebxml/hello"
*  
*/
