...
@XmlRootElement(name = "calcHeaderInfoResponse", namespace = "http://www.rk.in/schema/CalcHeader")
public class CalcHeaderInfoResponse {

    @XmlElement(namespace = "http://www.rk.in/schema/CalcHeader", required = true)
